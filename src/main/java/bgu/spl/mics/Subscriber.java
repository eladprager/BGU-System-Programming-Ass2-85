...
public abstract class Subscriber extends RunnableSubPub {
    private Map<Class<? extends Event>,Callback> EventcallbackMap;
    private Map<Class<? extends Broadcast>,Callback> BrodcallbackMap;
    ...
    protected final <B extends Broadcast> void subscribeBroadcast(Class<B> type, Callback<B> callback) {
            s1.subscribeBroadcast(type, this);
            BrodcallbackMap.put(type, callback);
    }
